...
<?php
	...
	?>
		...
		<div class="fb-share-button" data-href="<?php echo $urlToShare; ?>" data-layout="button" data-size="large"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo rawurlencode($urlToShare); ?>&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Megosztás</a></div>
