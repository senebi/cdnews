...
$configFile=dirname(__FILE__).$ds."..".$ds."config.ini";
if(!file_exists($configFile)){
	echo "$configFile: A konfigurációs fájl nem található!";
	exit();
}
$cdn_config=parse_ini_file($configFile, true, INI_SCANNER_TYPED);
...
$baseUrl=dirname($cdn_config["images"]["upload_dir.thumb"])."/";
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => $baseUrl,//alapértelmezett: '/ckfinder/userfiles/',
